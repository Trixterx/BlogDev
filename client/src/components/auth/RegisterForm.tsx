  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="form-group mb-3">
        ...
        name="name" value={name} onChange={handleChangeInput} placeholder="Name is up to 20 characters." />
      </div>
      ...
      <div className="form-group mb-3">
        ...
        name="account" value={account} onChange={handleChangeInput} placeholder="Example@gmail.com/+46701234567" />
      </div>
